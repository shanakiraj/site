...
export default function Education(){
    return (
        <section id="Education" className=" mx-auto mt-20 pt-20">
            <div className="bg-stone-700 flex justify-center gap-20 flex-wrap pb-10 pt-10">
            ...
            <div className="max-w-md p-10 ">
                ...
                <h1 className="text-5xl font-semibold pb-10">Skills</h1>
                </div>
                <div className="text-white pb-5 pr-5">
                <h3>Languages:</h3>
                ...
                <div className="text-white pb-5">
                <h3>Tech:</h3>
                <p>Git, Unix, Heroku, LaTeX, Visual Studio, VSCode, Eclipse, Jupyter Notebook, Docker, Kubernetes</p>
                </div>
            </div>
            </div>
        </section>
